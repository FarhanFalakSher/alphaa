  ...
  return (
    <section className="py-16 px-4 sm:px-8 md:px-16 lg:px-24 bg-white">
      <div className="max-w-7xl mx-auto text-center">
        {/* Title */}
        <motion.h2
          className="text-2xl sm:text-3xl md:text-4xl font-light mb-4 leading-snug"
        ...
        {/* Divider */}
        <motion.div
          className="w-16 sm:w-24 h-px bg-[#D4AF37] mx-auto my-6"
        ...
        {/* Subtitle */}
        <motion.p
          className="text-[#2C2C2C] text-sm sm:text-base max-w-xl sm:max-w-2xl mx-auto mb-10 sm:mb-12 px-2"
          variants={titleVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: '-50px' }}
          ...
          >
            <motion.div variants={imageVariants} whileHover="hover">
              <img
                ...
                className="w-24 h-24 sm:w-32 sm:h-32 rounded-full mx-auto mb-4 sm:mb-6 object-cover border-4 border-[#D4AF37]"
            ...
            <p className="text-[#D4AF37] mb-3 sm:mb-4 text-sm sm:text-base">
