  ...
  return (
    <section className="py-16 px-4 sm:px-8 md:px-16 lg:px-24 bg-white">
      <div className="max-w-7xl mx-auto">
        {/* Section Title */}
        <motion.h2
          className="text-2xl sm:text-3xl md:text-4xl font-light text-center mb-12 sm:mb-16 leading-snug"
        ...
        >
          {/* Card 1 */}
          <motion.div
            className="bg-[#f8f5f2] p-6 sm:p-8 rounded-xl text-center hover:shadow-lg transition-shadow duration-300"
          ...
          >
            ...
            >
              <svg
                ...
                strokeWidth="0"
                viewBox="0 0 512 512"
                className="text-[#D4AF37] mx-auto mb-4 sm:mb-6"
                height="36"
                width="36"
            ...
            <p className="text-sm sm:text-base text-[#2C2C2C]">
